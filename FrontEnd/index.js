...
function addFigures(photos){ //Définition et déclaration de la fonction addFigures, une fonction permet de condenser du code
...
.then(function(listPictures){ //va traiter les données
    ...
    for (let photos of listPictures) {//va parcourir listPictures et va le mettre dans photos et exécutera les lignes mises dans la boucle
